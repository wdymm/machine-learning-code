...
testData = OurDataset('/Users/jing/Desktop/cs446/hk/hk5/t10k-images-idx3-ubyte','~/Desktop/cs446/hk/hk5/t10k-labels-idx1-ubyte.dms',transform=transforms.Compose([
                           transforms.Normalize((255*0.1307,), (255*0.3081,))
                       ]))
trainData = OurDataset('/Users/jing/Desktop/cs446/hk/hk5/train-images-idx3-ubyte','~/Desktop/cs446/hk/hk5/train-labels-idx1-ubyte.dms',transform=transforms.Compose([
                           transforms.Normalize((255*0.1307,), (255*0.3081,))
                       ]))
